...
## Описание проекта
**C5_s21_decimal-1** — это учебная реализация типа `decimal` в языке C, который отсутствует в стандартной библиотеке, но необходим для точных финансовых вычислений.  
Этот тип чисел позволяет избежать ошибок округления, характерных для `float` и `double`, за счёт использования целочисленного представления и коэффициента масштабирования.  

## Основные возможности
- Представление десятичных чисел в диапазоне от  
  **-79,228,162,514,264,337,593,543,950,335** до  
  **+79,228,162,514,264,337,593,543,950,335**  
- Реализация основных арифметических операций: `+`, `-`, `*`, `/`  
- Операторы сравнения: `<`, `<=`, `>`, `>=`, `==`, `!=`  
- Функции преобразования `decimal <-> int` и `decimal <-> float`  
- Операции округления и инверсии знака  
